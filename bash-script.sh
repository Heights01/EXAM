...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=heights/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=heights/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=heights90/' /var/www/html/laravel/.env
